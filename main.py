...
def game_init():
    ...
    game_run['pipe_total_count'] = 8 * game_run['current_pass']
    # goodtimp
    gold_list.clear()
    # yao
    score = 0
...
def add_pipe():
    ...
    if len(pipe_list) == 0:
        ...
        game_run['pipe_total_count'] = game_run['pipe_total_count'] * game_run['current_pass']
...
def fraction(price):
    ...
    n = 0
    for i in str(score):
        screen.blit(scoreimg[int(i)], (screen_width//2-n*20, 550))
        n += 1
# ---- yao -----
